...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        gridLayout_3->addWidget(view_logging, 1, 0, 1, 2);

        TEST_input = new QLineEdit(groupBox_12);
        TEST_input->setObjectName(QString::fromUtf8("TEST_input"));

        gridLayout_3->addWidget(TEST_input, 0, 0, 1, 1);

        Slider = new QwtSlider(groupBox_12);
        Slider->setObjectName(QString::fromUtf8("Slider"));

        gridLayout_3->addWidget(Slider, 2, 0, 1, 1);
        ...
        verticalLayout_3->addWidget(button_disconnect);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        button_disconnect->setText(QApplication::translate("MainWindowDesign", "Disconnect", 0, QApplication::UnicodeUTF8));
