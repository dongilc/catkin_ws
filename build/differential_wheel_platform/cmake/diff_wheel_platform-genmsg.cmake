...
set(MSG_I_FLAGS "-Idiff_wheel_platform:/home/nvidia/workspace/catkin_ws/src/differential_wheel_platform/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nvidia/workspace/catkin_ws/src/differential_wheel_platform/msg/CTM_Message.msg" NAME_WE)
add_custom_target(_diff_wheel_platform_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "diff_wheel_platform" "/home/nvidia/workspace/catkin_ws/src/differential_wheel_platform/msg/CTM_Message.msg" ""
)
...
_generate_msg_cpp(diff_wheel_platform
  "/home/nvidia/workspace/catkin_ws/src/differential_wheel_platform/msg/CTM_Message.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/diff_wheel_platform)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/diff_wheel_platform\")")
  # install generated code
  install(
