/*
 * mjvesc_control_ex1_node.cpp
 * 
 *  Created on: Nov. 05, 2020
 *      Author: cdi
 */

#include "mjvesc_control.h"
...
void TeleopVesc::customsCallback(const mjvesc_msgs::MJVescGetCustomApp::ConstPtr& custom_rx_msg)
{
...
void TeleopVesc::stateCallback(const mjvesc_msgs::MJVescStateStamped::ConstPtr& state_msg)
{
...
int main(int argc, char **argv)            
{
  ...
  // TeleopVesc Class
  TeleopVesc *teleop_vesc1 = new TeleopVesc(4, "/dev/ttyACM0"); 
...
// TeleopInput Class
  ...
  { 
		...
		// current example (A)
		//teleop_vesc1->current[0] = 1.0;
		//teleop_vesc1->current[1] = 1.0;
		// teleop_vesc->current[2] = -1.0;
		// teleop_vesc->current[3] = 1.0;
		//teleop_vesc1->setCurrentOut();
		...
		teleop_vesc1->duty[1] = 0.1;
		teleop_vesc1->duty[2] = 0.1;
		teleop_vesc1->duty[3] = 0.1;
