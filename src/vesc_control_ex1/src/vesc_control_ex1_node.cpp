...
#define VESC_ID_END				VESC_ID_3	// Change this depend on your condition
...
//   teleop_vesc->setCustomOut();
  ...
  while (ros::ok())
  {
		...
		// teleop_vesc->duty[0] = 0.3;
		// teleop_vesc->duty[1] = -0.1;
		// teleop_vesc->duty[2] = -0.3;
		...
		teleop_vesc->custom_cmd_value[0] = 0.1;
